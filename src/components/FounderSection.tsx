  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24">
        ...
        >
          <p className="text-white/70 font-mono text-sm tracking-widest uppercase mb-6">
            Our Story
          </p>
          <h2 className="text-4xl md:text-6xl font-black text-white leading-tight mb-8 font-display">
            Built by Founders Who
            <br />
            <span className="text-white/40">Refuse to Wait.</span>
          </h2>
